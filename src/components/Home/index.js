...
export { HeroSection } from './HeroSection/HeroSection.js'
...
export { CompaniasSection } from './CompaniasSection.js'
export { EquipoSection } from './EquipoSection/EquipoSection.js'

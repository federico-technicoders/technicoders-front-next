...
export const SocioEstrategicoSection = () => {
    return (
        <SectionPage>
            <div className="flex w-full  bg-white text-black h-[952px] -z-20">
                ...
                <aside className="relative flex flex-col items-start justify-end gap-y-10 w-1/2  px-[5%] py-16">
                    ...
                    <img src="/assets/images/image.webp" alt="imagen" className="absolute top-0 left-0 w-full h[952px] -z-10" />
                </aside>
                <div 

...
//bg-[#0E1629]
    return (
        <>
            ...
            >
                <div className="flex flex-col lg:flex-row justify-start items-start lg:justify-between lg:items-center gap-5 w-full">
                    ...
                    <div className="">
                        <p>Barcelona</p>
                        <p className="text-nowrap">Calle Vilamarí 81, 7º - 3ª, Eixample</p>
                        <p>+34 123 456 789</p>
                    </div>
                </div>            
            </footer>
